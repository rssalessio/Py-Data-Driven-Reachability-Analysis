...
def compute_LTI_matrix_zonotope(X0: np.ndarray, X1: np.ndarray, U0: np.ndarray, Mw: MatrixZonotope) -> MatrixZonotope:
    """
    ...
    Msigma = MatrixZonotope(X1.T - Mw.center, Mw.generators)
